...
public class DatabaseManager {
    ...
    public synchronized void normalizzaPrezziMedi() throws SQLException {
        String sql = "UPDATE ristorantitheknife SET prezzo_medio = CASE " +
    ...
    public synchronized boolean modificaRistorante(int id, String nome, String indirizzo,
        ...
        String sql = "UPDATE ristorantitheknife SET \"Name\"=?, address=?, \"Location\"=?, cuisine=?, " +
    ...
    public synchronized List<Ristorante> cercaRistoranti(
        ...
        sql.append("FROM ristorantitheknife r LEFT JOIN recensioni rec ON r.id_ristorante=rec.ristorante_id WHERE 1=1 ");
    ...
    public synchronized boolean rispondiRecensione(int recensioneId,
        ...
        String checkSql =
            ...
            "FROM recensioni rec " +
            "JOIN ristorantitheknife r ON rec.ristorante_id = r.id_ristorante " +
        ...
        String sql = "UPDATE recensioni SET risposta_gestore = ? " +
                     "WHERE id = ? AND EXISTS (SELECT 1 FROM ristorantitheknife r " +
